...
const createOrg = ({ organization, owner, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return new api_500_error_1.default("Failed to create new organization.");
    }
});
...
const retrieveOrg = ({ user, organizationId, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return new api_500_error_1.default("Failed to retrieve organizations.");
    }
});
...
const deleteOrg = ({ organizationId, owner, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!org) {
            return new api_404_error_1.default("Failed to find organization with this id.");
        }
        ...
        return new api_500_error_1.default("Failed to delete organization.");
    }
});
...
const inviteMember = ({ user, memberEmail, organizationId, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!newMember) {
            return new api_404_error_1.default("Failed to find member to invite.");
        }
        ...
        return new api_500_error_1.default("Failed to invite member to organization.");
    }
});
...
const joinOrg = ({ user, organizationId, inviatationId, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return new api_500_error_1.default("Failed to join organization");
    }
});
...
const sendEmail = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return new api_500_error_1.default("Failed to send inviatation via email.");
    }
});
