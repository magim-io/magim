...
const mapService = __importStar(require("../services/maps.service"));
const createMap = (0, async_handler_middleware_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const payload = req.body;
    const repository = JSON.stringify(req.headers["x-github-repository"]);
    let map;
    map = yield mapService.createMap({
        payload: JSON.stringify(payload),
        repository: repository,
    });
    if (map instanceof base_error_error_1.default) {
        return next(map);
    }
    res.status(201).json({
        success: true,
