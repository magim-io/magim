...
class Api404Error extends base_error_error_1.default {
    constructor(name, statusCode = http_status_codes_constant_1.default.NOT_FOUND, description = "Not found.", isOperational = true) {
